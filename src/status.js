...
const { paths, groups, app, smtp } = require('./config');
...
console.log('Last email       ' + formatUkDateTime(s.lastEmailAt));
console.log('Recipients       ' + (smtp.to.length ? smtp.to.join(', ') : 'None configured'));
